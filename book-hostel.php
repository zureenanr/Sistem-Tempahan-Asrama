...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: red" align="center">Asrama sudah ditempah oleh anda</h3>
			<div align="center">
...
<label class="col-sm-4 control-label"><h4 style="color: green" align="left">Maklumat Berkaitan Bilik </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">Bayaran Sebulan</label>
<div class="col-sm-8">
...
<div class="col-sm-8">
<input type="radio" value="0" name="foodstatus" checked="checked"> Tanpa Makanan
<input type="radio" value="1" name="foodstatus"> Dengan Makanan(RM 100.00 Sebulan Tambahan)
</div>
</div>	
...
<div class="form-group">
<label class="col-sm-2 control-label">Jangka Masa</label>
<div class="col-sm-8">
<select name="duration" id="duration" class="form-control">
<option value="">Pilih Tempoh dalam Bulan</option>
...
<div class="form-group">
<label class="col-sm-2 control-label"><h4 style="color: green" align="left">Maklumat peribadi </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-3 control-label"><h4 style="color: green" align="left">Alamat </h4> </label>
</div>
