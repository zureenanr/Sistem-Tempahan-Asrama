	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:4%">Menguruskan Pelajar Berdaftar</h2>
						<div class="panel panel-default">
							<div class="panel-heading">Semua Maklumat Bilik Asrama</div>
